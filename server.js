...
const authRoutes       = require('./route-auth-v2');
const employeeRoutes   = require('./route-employees-v2');
const companyRoutes    = require('./route-companies');
const payrollRoutes    = require('./route-payroll-v2');
const leaveRoutes      = require('./route-leave-v2');
const attendanceRoutes = require('./route-attendance-v2');
const userRoutes       = require('./route-users-v2');
